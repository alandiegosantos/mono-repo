...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:DaxtlTJjFSnLOXVNUBU1+6kXGz2lpDoEAH6QoxaSg8k=",
        version = "v23.0.5+incompatible",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Ei1FUQ5CbSNkl2o/XAiksXSyQNAeJBX3ivqJpJ254Ak=",
        version = "v0.41.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:2MM7m6wPw9B8Qv8iHygoAgkbejed59uUR6ezR5T3X2s=",
        version = "v0.38.1",
    )
    go_repository(
